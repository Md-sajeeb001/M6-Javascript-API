...
// 2-1. write an arrow function where it will do the following:
...
// let newArray = [];
let sum = 0;
const arrowFunction = (numbers) => {
    for(const num of numbers){
        const mulNum = num * num;
        console.log(mulNum);
        sum = sum + mulNum;
        console.log(sum)
        const averageNum = sum / mulNum;
        console.log(averageNum.toFixed(2))
    }
}

const arrayOfNumbers = [4, 12, 30, 8, 7, 5]
const nums = arrowFunction(arrayOfNumbers);
